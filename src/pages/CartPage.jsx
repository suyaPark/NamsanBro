...
const CartPage = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
      <h1 className="text-3xl font-light tracking-tight text-gray-900 mb-8">Your Cart</h1>
      {cart.length === 0 ? (
        <div className="text-center py-12">
          ...
          <button 
            ...
            className="mt-4 bg-black text-white py-3 px-8 rounded-full hover:bg-gray-800 transition-colors duration-200"
          >
            Browse Products
          </button>
        </div>
        ...
        <div className="space-y-6">
          {cart.map((item) => {
            ...
            return (
              <div key={item.id} className="flex items-center gap-6 p-6 bg-white rounded-2xl border border-gray-200">
                <img 
                  src={item.images[0]} 
                  ...
                  <div className="flex items-center gap-4 mt-2">
                    <div className="flex items-center gap-2">
                      <button
                        ...
                        className="bg-gray-200 rounded-l-full px-2 py-1 hover:bg-gray-300 disabled:opacity-50"
                      ...
                      <button
                        ...
                        className="bg-gray-200 rounded-r-full px-2 py-1 hover:bg-gray-300"
                      >
                        <Plus size={16} />
                      </button>
                    </div>
          ...
          <div className="bg-white p-6 rounded-2xl border border-gray-200">
            <div className="space-y-4">
              ...
              <div className="flex justify-between items-center text-lg font-medium pt-4 border-t">
                <span>Total</span>
            ...
            {!user ? (
              <button
                ...
                className="w-full bg-black text-white py-3 px-4 rounded-full hover:bg-gray-800 transition-colors duration-200 font-medium mt-6"
              >
                Sign In to Checkout
              </button>
            ) : (
              <button
                onClick={checkout}
                disabled={loading}
                className="w-full bg-black text-white py-3 px-4 rounded-full hover:bg-gray-800 transition-colors duration-200 font-medium mt-6 disabled:bg-gray-300 disabled:cursor-not-allowed"
              >
